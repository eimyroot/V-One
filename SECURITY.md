...
- external identity bindings and role mappings are exact, unique and append-only,
- only an active administrator may provision external identity records,
- external groups may confirm but never mutate or elevate the current internal role,
